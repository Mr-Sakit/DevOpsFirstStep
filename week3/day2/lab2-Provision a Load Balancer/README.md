...
![Step 1 — VM1 Basics tab (Project & Instance details)](Screenshot%202026-03-04%20110128.png)

![Step 1 — VM1 Basics tab (Admin account & Inbound ports)](Screenshot%202026-03-04%20110138.png)
...
![Step 1 — VM1 Disks tab](Screenshot%202026-03-04%20110219.png)
...
![Step 1 — VM1 Networking tab](Screenshot%202026-03-04%20110348.png)
...
![Step 1 — Edit virtual network](Screenshot%202026-03-04%20110510.png)

![Step 1 — VM1 Networking (after VNet config)](Screenshot%202026-03-04%20110608.png)

![Step 1 — VM1 Networking (Review + create)](Screenshot%202026-03-04%20110824.png)

#### Review + Create & Key Download

![Step 1 — VM1 Review + create and SSH key download](Screenshot%202026-03-04%20111217.png)

#### Deployment Complete

![Step 1 — VM1 deployment complete](Screenshot%202026-03-04%20111407.png)
...
![Step 1 — VM2 Basics tab](Screenshot%202026-03-04%20111726.png)

![Step 1 — VM2 Admin account (reuse existing SSH key)](Screenshot%202026-03-04%20111745.png)
...
![Step 1 — VM2 Disks tab](Screenshot%202026-03-04%20111814.png)
...
![Step 1 — VM2 Networking tab](Screenshot%202026-03-04%20111923.png)

#### Deployment Complete

![Step 1 — VM2 deployment complete](Screenshot%202026-03-04%20112108.png)
...
![Step 2 — VM1 Network settings — Add inbound rule for port 80](Screenshot%202026-03-04%20112300.png)
...
![Step 3 — Apache running on VM1](Screenshot%202026-03-04%20113725.png)
...
![Step 3 — Custom index.html on VM1 (first server)](Screenshot%202026-03-04%20123445.png)
...
![Step 3 — Custom index.html on VM2 (second server)](Screenshot%202026-03-04%20123526.png)
...
![Step 4 — Load Balancers page → Create](Screenshot%202026-03-04%20123637.png)

![Step 4 — LB Basics tab](Screenshot%202026-03-04%20123843.png)
...
![Step 4 — Frontend IP configuration](Screenshot%202026-03-04%20124527.png)
...
![Step 4 — Backend pools tab](Screenshot%202026-03-04%20124622.png)

![Step 4 — Add backend pool with both VMs](Screenshot%202026-03-04%20124835.png)
...
![Step 4 — Add load balancing rule](Screenshot%202026-03-04%20130024.png)

![Step 4 — Inbound rules summary](Screenshot%202026-03-04%20182421.png)

### Review + Create

![Step 4 — Review + create (Validation passed)](Screenshot%202026-03-04%20182450.png)
...
![Step 5 — Load Balancer Overview](Screenshot%202026-03-05%20072201.png)

### Frontend IP Configuration

![Step 5 — Frontend IP configuration (20.33.40.107)](Screenshot%202026-03-05%20072402.png)
...
![Step 6 — Browser showing "second server" via LB IP](Screenshot%202026-03-05%20073444.png)

### Response from First Server:

![Step 6 — Browser showing "first server" via LB IP](Screenshot%202026-03-05%20073952.png)
